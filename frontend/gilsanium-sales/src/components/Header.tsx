      ...
      <div className="flex flex-wrap items-center justify-between h-auto min-h-16 lg:px-10 px-4 py-3 gap-y-2">
        ...
        <div className="flex items-center text-secondary-200 min-w-0 relative">
          ...
          {isProfileDropdownOpen && (
            <div className="absolute top-full mt-2 bg-white border border-[#EFEFEF] items-center rounded-[12px] shadow-lg lg:w-72 z-50 left-1/2 -translate-x-1/2 sm:left-6 sm:right-0 sm:translate-x-0">
              {/* User Info Section */}
